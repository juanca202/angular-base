...
import { SubscriptionDetailComponent } from 'app/shared/subscription-detail/subscription-detail.component';
...
export class SettingsComponent implements OnInit {
  ...
  public notificationsCount: WritableSignal<number> = signal(0);
  public spaces: WritableSignal<number> = signal(0);
  public categories: WritableSignal<number> = signal(0);
  public tags: WritableSignal<number> = signal(0);
  public language: WritableSignal<Language> = signal({
    code: 'en',
    name: 'English'
  });
  ...
  public subscribing: WritableSignal<boolean> = signal(false);
