...
4. Si propones UI que el usuario verá, respeta **`environment.defaultLocale`** y la clave `internationalization` en `docs/MEMORY.md` / **ADR-014** cuando toque texto visible.
