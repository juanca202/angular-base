 ...
 *   FIGMA_ACCESS_TOKEN=xxx node .cursor/skills/abp-extract-figma-icons/fetch-figma-icons.js <fileKey> <nodeId>
 *   FIGMA_ACCESS_TOKEN=xxx node .cursor/skills/abp-extract-figma-icons/fetch-figma-icons.js https://figma.com/design/VT4W8MFWwD8k1TYcABLEjf/Design-system-template?node-id=6-2
 *
...
async function main() {
  ...
  if (parsed) {
    ...
    console.error(
      'Usage: FIGMA_ACCESS_TOKEN=xxx node .cursor/skills/abp-extract-figma-icons/fetch-figma-icons.js <fileKey> <nodeId>'
    );
    console.error(
      '   or: FIGMA_ACCESS_TOKEN=xxx node .cursor/skills/abp-extract-figma-icons/fetch-figma-icons.js <figma-url-with-node-id>'
    );
    process.exit(1);
  }
