...
- [ADR-003: Uso de Tailwind CSS para Clases Utilitarias y Creación de Componentes](./ADR-003-css-utilities.md)
- [ADR-004: Estrategia de Internacionalización (i18n)](./ADR-004-internationalization-strategy.md)
- [ADR-005: Patrón de Repositorio para Servicios REST](./ADR-005-repository-pattern.md)
- [ADR-006: Estrategia de Testing](./ADR-006-testing-strategy.md)
- [ADR-007: Estrategia de Validación de Formularios](./ADR-007-form-validation-strategy.md)
- [ADR-008: Calidad de Código y Herramientas](./ADR-008-code-quality-tooling.md)
- [ADR-009: Estrategia de Uso de Iconos](./ADR-009-icon-usage-strategy.md)
- [ADR-010: Estrategia de Documentación](./ADR-010-documentation-strategy.md)
- [ADR-011: Convención de modificadores de acceso y uso de readonly en TypeScript](./ADR-011-typescript-access-modifiers.md)
...
- [ADR-014: Patrón Manager para Coordinación de Flujos de Negocio](./ADR-014-manager-pattern.md)
