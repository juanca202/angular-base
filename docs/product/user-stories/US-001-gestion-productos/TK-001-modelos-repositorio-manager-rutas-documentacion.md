...
- **Ubicación en código:** `src/app/features/catalog/` (modelos, `product-repository.ts`, `product-manager.ts`, `catalog-routes.ts` o nombre acordado, `app.routes.ts`)
