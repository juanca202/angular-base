...
**📖 [English](../en/architecture.md) | [Español](./architecture.md)**
...
Este proyecto sigue el formato de Architectural Decision Records (ADR) para documentar decisiones arquitectónicas clave. Cada ADR se mantiene como un documento separado en el directorio [`decisions/`](./decisions/).

## Índice de ADRs

- **[ADR-001: Separación de Responsabilidades - Core, Shared y Features](./decisions/ADR-001.md)**  
  Define la arquitectura de tres capas (Core, Shared, Features) con reglas de dependencia claras y separación de concerns.

- **[ADR-002: Adopción de la Guía de Estilo Oficial de Angular](./decisions/ADR-002.md)**  
...
- **[ADR-006: Patrón de Repositorio para Servicios REST](./decisions/ADR-006.md)**  
...
- **[ADR-007: Estrategia de Testing](./decisions/ADR-007.md)**  
...
- **[ADR-008: Estrategia de Validación de Formularios](./decisions/ADR-008.md)**  
...
- **[ADR-009: Calidad de Código y Herramientas](./decisions/ADR-009.md)**  
...
- **[ADR-010: Estrategia de Uso de Iconos](./decisions/ADR-010.md)**  
...
- **[ADR-011: Estrategia de Documentación](./decisions/ADR-011.md)**  
...
1. Crea un nuevo archivo: `docs/decisions/ADR-XXX.md`
