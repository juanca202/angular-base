...
**📖 [English](../en/decisions/ADR-007.md) | [Español](./ADR-007.md)**
...
1. **Unit Testing:** Jest para testear unidades individuales (componentes, servicios, utilidades) en aislamiento
...
- **jest-preset-angular:** Configuración específica de Jest para Angular
