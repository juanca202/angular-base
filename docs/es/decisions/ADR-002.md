...
**📖 [English](../en/decisions/ADR-002.md) | [Español](./ADR-002.md)**
...
**Regla:** Usar kebab-case (guiones) para separar palabras en nombres de archivos.
...
**Estándar de sufijos:** Las clases Guard, Pipe, Resolver e Interceptor deben terminar con su sufijo correspondiente y el nombre del archivo debe reflejarlo (por ejemplo, `auth.guard.ts`, `format-currency.pipe.ts`).
