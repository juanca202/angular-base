...
**📖 [English](../en/decisions/ADR-005.md) | [Español](./ADR-005.md)**
...
### Reglas de Código (de `.cursor/rules/cursor.mdc`)

- **Todo el texto visible en la UI debe usar el atributo `i18n`**
- **No cadenas hardcodeadas** en templates
...
- **Plataforma de Gestión de Traducciones:** Integrar con servicios como Crowdin, Lokalise o Phrase
- **Reglas de Pluralización:** Asegurar pluralización adecuada para todos los idiomas
- **Soporte RTL:** Considerar soporte para idiomas de derecha a izquierda
- **Formateo de Fecha/Hora:** Ya manejado vía locale de moment.js
- **Formateo de Números:** Considerar formateo de números específico por locale
- **Carga Diferida:** Implementar carga de traducciones basada en features para rendimiento
...
- [Reglas de Cursor - Idioma y Localización](../../.cursor/rules/cursor.mdc#language--localization)
