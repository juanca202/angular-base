...
Este directorio contiene toda la documentación del proyecto, organizada en las siguientes secciones:

## Estructura de Documentación

### 📋 [Especificaciones (Specs)](./specs/)

Contiene las especificaciones técnicas y funcionales del proyecto:

- **[Features](./specs/features/)**: Documentación de features y funcionalidades
- **[Flows](./specs/flows/)**: Flujos de usuario y procesos
- **[Rules](./specs/rules/)**: Reglas de desarrollo, guías de estilo y convenciones

### 🏗️ [Decisiones Arquitectónicas (ADRs)](./adr/)

Registros de Decisiones Arquitectónicas que documentan decisiones técnicas significativas del proyecto.

Ver el [índice completo de ADRs](./adr/README.md).

### 📚 [Glosario](./glossary/)

Definiciones de términos técnicos y de dominio utilizados en el proyecto.
...
4. Actualiza el índice en `docs/adr/README.md` con un enlace al nuevo ADR
