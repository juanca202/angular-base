...
**Testing**: Vitest (unit/integration), Playwright (E2E) - see [ADR-015](./docs/adr/ADR-015-testing-strategy.md)  
...
- ✅ **Testing**: Tests follow AAA pattern, ≥80% coverage for critical paths, signals treated as state (ADR-015)
- ✅ **Code Quality**: ESLint, Prettier, Conventional Commits enforced (ADR-011)
